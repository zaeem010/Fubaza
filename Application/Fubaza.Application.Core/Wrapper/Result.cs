...
namespace Fubaza.Application.Core.Wrapper
{
    public class Result : IResult
    {
        ...
        public static Task<IResult> FailAsync(List<string> messages, params object[] args)
        {
    ...
    public class Result<T> : Result, IResult<T>
    {
        ...
        public static new Task<Result<T>> FailAsync(List<string> messages, params object[] args)
        {
