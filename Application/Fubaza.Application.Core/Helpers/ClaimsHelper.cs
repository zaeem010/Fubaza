...
namespace Fubaza.Application.Core.Helpers
{
    public static class ClaimsHelper
    {
        public static void GetAllPermissions(this List<RoleClaim> allPermissions)
        {
            ...
            foreach (var module in modules)
            {
                ...
                foreach (var fi in fields)
                {
                    ...
                    if (propertyValue != null)
                        allPermissions.Add(new RoleClaim() { ClaimValue = propertyValue.ToString(), ClaimType = ApplicationClaimTypes.Permission, Group = moduleName, Description = moduleDescription });
                }
            }
        }
        ...
        public static async Task AddCustomPermissionClaim(this RoleManager<Role> roleManager, Role role, string permission)
        {
            var allClaims = await roleManager.GetClaimsAsync(role);
            if (!allClaims.Any(a => a.Type == ApplicationClaimTypes.Permission && a.Value == permission))
            {
